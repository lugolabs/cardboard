...
set :linked_files,          %w(config/database.yml config/sidekiq.yml config/application.yml config/deploy/server.rb)
set :linked_dirs,           %w(log tmp/pids tmp/cache tmp/sockets tmp/downloads public/uploads vendor/bundle)
...
set :repo_url,              "git@github.com:lugolabs/#{fetch(:application)}.git"
set :keep_releases,         3
set :keep_assets,           1
